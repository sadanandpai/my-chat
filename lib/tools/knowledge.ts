...
export const searchKnowledgeTool = tool(
  ...
  },
  {
    ...
    description:
      "Look up DEEP details about Sadanand Pai's career story, skills, and technical work: interviews and hiring processes (rounds, format, outcome) at any company, what he actually did at a past employer, work projects, accomplishments, opinions shaped by his work. ALWAYS call this when a company is named alongside anything beyond the bare fact of employment — interviews, rounds, offers, rejections, teams, day-to-day work. Only skip it for pure bio/overview lookups (the list of employers, role titles, years of experience, location, contact/socials, hobbies, games) — those are handled by getIntro. Do NOT use for whether he knows a person / colleagues / mentors / friends — use lookup_person. Do NOT use as the primary source for open-source / GitHub project catalogs, repo links, star counts, or project tech stacks — use lookup_projects for those (this tool is fine as a follow-up for career-story context around how an OSS project started).",
    schema: z.object({
      query: z
        .string()
        .describe(
