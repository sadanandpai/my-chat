...
export const searchKnowledgeTool = tool(
  ...
  },
  {
    ...
    description:
      "Look up DEEP details about Sadanand Pai's career story, skills, and technical work: interview rounds/format, day-to-day work at an employer, accomplishments, opinions shaped by his work. ALWAYS call this when a company is named alongside anything beyond the bare fact of employment — rounds, teams, products built, how he left. First confirm the company via lookup_company when the ask is 'did you work/interview at X' or when listing employers; this tool is for depth after that, not the authoritative yes/no roster. Pure bio (location, contact/socials, hobbies, games) → getIntro. Employer list / 'where did you work' / bare 'did you work at X' → lookup_company. People → lookup_person. OSS project catalogs → lookup_projects (this tool is fine as follow-up for career-story context around how an OSS project started).",
    schema: z.object({
      query: z
        .string()
        .describe(
